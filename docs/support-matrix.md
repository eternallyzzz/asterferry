...
| Container/Helm upgrade | Image/chart rollout by the deployment platform; in-container binary replacement is unsupported | Update API reports rollout-required status; deployment manifests use explicit container mode |
