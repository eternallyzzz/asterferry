...
type Config struct {
	...
	NodeInstallersDir    string `json:"node_installers_dir"`
...
func (c Config) Validate() error {
	...
	for field, value := range map[string]string{"node_installers_dir": c.NodeInstallersDir, "ca_key_path": c.CAKeyPath, "ca_cert_path": c.CACertPath, "tls_cert_path": c.TLSCertPath, "tls_key_path": c.TLSKeyPath, "master_key_path": c.MasterKeyPath} {
