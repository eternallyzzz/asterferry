...
func controllerSchemaStatements(types schemaTypes) []string {
	return []string{
		...
		fmt.Sprintf(`CREATE TABLE observed_states (
			...
			)`, types.bigInteger, types.integer, types.integer, types.integer, types.blob, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger, types.integer, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger, types.bigInteger),
		...
		fmt.Sprintf(`CREATE TABLE node_bootstraps (node_id TEXT PRIMARY KEY, name TEXT NOT NULL, labels_json %s NOT NULL, enabled %s NOT NULL, platform TEXT NOT NULL, arch TEXT NOT NULL, script_source TEXT NOT NULL DEFAULT 'controller', spec_json %s, token_hash TEXT NOT NULL UNIQUE, expires_at TEXT NOT NULL, created_at TEXT NOT NULL)`, types.blob, types.bigInteger, types.blob),
...
func validateRequiredTables(ctx context.Context, db *sql.DB, dialect databaseDialect) error {
	...
	requiredColumns := map[string][]string{
		...
		"node_bootstraps":         {"node_id", "name", "labels_json", "enabled", "platform", "arch", "script_source", "spec_json", "token_hash", "expires_at", "created_at"},
