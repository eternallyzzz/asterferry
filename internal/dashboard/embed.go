...
// dashboardAssets and dashboardAssetRoot are supplied by the build-tagged
// asset providers. Normal Go builds use the source fallback page; release
// builds use the generated Vue/Vite bundle.

func Handler() http.Handler {
	assets, err := fs.Sub(dashboardAssets, dashboardAssetRoot)
	if err != nil {
