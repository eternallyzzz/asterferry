// Package control contains the protocol glue shared by the Controller and
// nodes.  Generated protobuf types live in control/v1; this package adds
...
func Heartbeat(nodeID string, generation uint64, healthy bool) *v1.Heartbeat {
	_ = nodeID // node identity is carried by the enclosing stream's Hello.
