...
const formError = ref("");
const proxyForm = ref<{ id: string; protocol: ProxySpec["protocol"]; bind: string; route: string; enabled: boolean }>({ id: "", protocol: "tcp", bind: "0.0.0.0:1080", route: "", enabled: true });
